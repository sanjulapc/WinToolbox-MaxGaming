...
# working folder (where downloads land / where the toolboxes are launched from)
...
$hdr.Add_Paint({
    ...
    # title
    $g.DrawString('WINTOOLBOX HUB', $script:F.Title, $wb, (New-Object System.Drawing.PointF(26, 48)))
    # greeting
...
$lblVer.Text = "WinToolbox Hub $($script:Hub.Version)"
